...
export function createMockFacilitatorClient(
...
): FacilitatorClient & { counts: MockFacilitatorCallCounts; setVerifyMode: (mode: MockVerifyMode) => void; setSettleMode: (mode: MockSettleMode) => void } {
  ...
  const transactionHash =
    options.transactionHash ?? `0x${"ab".repeat(32)}`;
